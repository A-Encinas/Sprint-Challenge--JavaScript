...
If the keyword new is being used in the function it turns this into a whole new object. When the apply call and bind words are used to call a function the word this is used to be passed in the argument. If dot notation is being used then this is considered the object that the function is a property of. If a function is invoked as a free function this turns out to be a global object.
